...
BASIC_EXAMPLE_FILE = ROOT_DIRECTORY / "plotly_selectable_chart" / "example.py"
...
def test_should_render_template(page: Page):
    frame_0 = page.frame_locator('iframe[title="plotly_selectable_chart\\.plotly_selectable_chart"]').nth(0)
    frame_1 = page.frame_locator('iframe[title="plotly_selectable_chart\\.plotly_selectable_chart"]').nth(1)
...
def test_should_change_iframe_height(page: Page):
    frame = page.frame_locator('iframe[title="plotly_selectable_chart\\.plotly_selectable_chart"]').nth(1)

    expect(frame.get_by_text("Hello, Streamlit!")).to_be_visible()

    locator = page.locator('iframe[title="plotly_selectable_chart\\.plotly_selectable_chart"]').nth(1)
